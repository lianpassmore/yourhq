...
#
# DIAGRAM CALLOUTS: All places where a visual asset must be placed are marked:
# ⬛ DIAGRAM REQUIRED: [description of what goes here]
# These must be implemented by the developer using the YourHQ Visual Reference Maps HTML file.
...
too good to look average online.

## Hero Subtext
You've been meaning to sort this.
...
## SECTION: The Work — Portfolio Strip
# Appears immediately below hero.
# Purpose: show the work before explaining the process.
...
## SECTION: Meet Lian
# Appears before the process and pitch.
# Purpose: put a real person front and centre early.
...
Most clients are live within 1–2 weeks and spend less than 30 minutes on their end.
...
Hand-coded in Astro. Under a second to load. Mobile-first. Built for standard search and AI-generated answers. Future-ready.
...
### Step 05 — Preview
**Your time: however long you want**
...
### Step 07 — The Caretakers Take Over
**Your time: a text, when you need me**
...
### Body
Most web designers build your site, send the invoice, and move on. Three years later your site looks dated, something breaks, and you're starting from scratch with someone new.
...
**How much time does this take from my end?**
...
Hand-coded. Under a second to load. Mobile-first. Built for standard search and AI-generated answers. Yours unconditionally from day one.
...
### Not My Lane — I'll Point You Somewhere Good

| If you need | I'll send you to |
|---|---|
| Physical products, inventory, shipping | A Shopify developer |
| Full course platform + community | A Kajabi consultant |
| Paid community or membership platform | Circle or Mighty Networks |
...
| Custom web app or SaaS | A dev agency |

*I'd rather refer you well than take the job and do it badly.*

---

## SECTION: Monthly Caretaker Fee
...
## SECTION: What You're Comparing

### Headline
The Real Cost Isn't the Setup Fee.

⬛ DIAGRAM REQUIRED: Comparison table
— Reference: Diagram 06 (Pricing Structure / Cost Model) from YourHQ Visual Reference Maps HTML file
— OR use the table below rendered as a styled component
— 4 columns: DIY / Traditional Agency / YourHQ
— YourHQ column highlighted
...
## SECTION: Why Subscription

### Headline
Why Is There a Monthly Fee?

Because a website isn't a product you buy once. It's infrastructure that needs to run, stay secure, stay current, and keep up with you as you grow.
...
One conversation. Everything handled. Looked after forever.
...
# who-we-build-for.astro
# Consolidated audience page — replaces previous Tradies / Professionals / Creatives pages
...
### Closing
Different industries. Same standard. Same process. Same care.
...
- DIYers who want to tinker
- Anyone looking for the cheapest option
- People who want to be involved in the build
...
# NOTE TO DEVELOPER: Each project card below requires a site screenshot.
# Use device mockups — mobile preferred as these sites are mobile-first.
# Screenshots should show the homepage of each live site.
...
Badges: ZERO HOMEWORK · CONTENT RAID · FAST BUILD

---

## SECTION: What Every Build Has in Common
...
That's not a technical argument. It's a values one.

### Callout
**My purpose is to manifest greatness in others.**

I genuinely believe that having a permanent, authentic digital home is part of that. It's the foundation everything else gets built on.
...
YourHQ launched in Northland and my first client outside New Zealand came from San Francisco before I'd finished setting up the systems.

That told me everything I needed to know.

The problem I'm solving isn't a New Zealand problem. It's everywhere. So while YourHQ is proudly founded in Aotearoa, it was always going to be global. We just got there faster than expected.
...
**Frictionless or I haven't done my job.** If the process feels hard, I've failed.
...
## Page Subhead
One conversation is all it takes. Tell me a bit about yourself and I'll take it from there.
...
**Step 1 — You send this form**
Takes two minutes.

**Step 2 — I get back to you**
...
**What does "hand-coded" mean in practice?**
...
**What if I want to move my site somewhere else?**
...
**What currency do international clients pay in?**
New Zealand dollars. Your bank handles the conversion.
